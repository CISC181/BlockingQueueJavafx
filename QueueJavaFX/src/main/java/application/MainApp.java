...
public class MainApp extends Application {
	...
	public void showMainScreen() {
		try {
			...
			loader = new FXMLLoader(getClass().getResource("/application/view/ShowQueue.fxml"));
			...
			scene.getStylesheets().add(MainApp.class.getResource("/application/view/application.css").toExternalForm());
